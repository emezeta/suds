...
`currently maintained Python version <https://devguide.python.org/#status-of-python-branches>`_
and Python 2.7.
...
The ``Doctor`` class provides the interface for classes that provide this
